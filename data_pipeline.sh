...
ulimit -Sn 1000000 && python deduplicate.py --input_dataset_name=$TMP_DATASETS/merged_composed_dataset --output_dataset_name=$TMP_DATASETS/deduplicated_composed_dataset --text_column=text --num_proc=$PROC
